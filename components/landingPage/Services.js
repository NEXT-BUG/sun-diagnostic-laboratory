...
const Services = () => {
  return (
    <div className="bg-gradient-to-r from-primary to-[#374957] w-screen h-full pb-10 lg:pb-32 relative pt-10">
...
const Cards = ({ title, description, image }) => {
  return (
    <div className="md:cursor-pointer bg-white duration-700 ease-out group shadow-lg px-5 w-[16rem] z-10 space-y-5 rounded-sm">
      <div className="translate-y-10 group-hover:translate-y-5 duration-200 ease-out">
        {image}
      </div>
      <p className="text-[#313131] text-center font-bold text-xl translate-y-10 group-hover:translate-y-5 duration-200 ease-out">
        {title}
      </p>
      <div className="h-1 group-hover:translate-y-5 duration-200 ease-out bg-primary w-full translate-y-10 rounded-full" />
      <p className="group-hover:-translate-y-1 translate-y-10 group-hover:invisible duration-200 ease-out group-hover:text-black text-center font-bold text-black">
        See More
      </p>
      <p className=" text-black translate-y-5 invisible group-hover:visible group-hover:text-black group-hover:-translate-y-5 duration-200 ease-out  text-sm">
        {description}
      </p>
    </div>
  );
