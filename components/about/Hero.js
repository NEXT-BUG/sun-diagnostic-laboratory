...
const Hero = ({ aboutRef }) => {
  ...
  return (
    <div>
      ...
      <Image
        alt="bg"
        src={require("../../assets/images/hero-img-3.png")}
        className="w-full absolute -z-50 opacity-30"
      />
      <div className="flex flex-col h-full lg:flex-row text-center lg:text-left items-start w-2/3 mx-auto space-x-10 justify-between mt-20">
        ...
        <div className="flex flex-col lg:w-2/3 space-y-5 mb-20">
          ...
          <p className="font-ubuntu text-xs">
            ...
            the clinical oversight of Experienced Consultants. Sun Diagnostic
            Lab represents a new paradigm for pathology services. Sun Diagnostic
