...
const About = () => {
  return (
    <div className="bg-gradient-to-b from-primary to-black w-screen h-full relative pt-10">
      ...
      <div className="text-white mt-5 flex flex-col lg:flex-row items-center lg:items-start text-center lg:text-left space-y-5 lg:space-y-0 justify-evenly p-10">
